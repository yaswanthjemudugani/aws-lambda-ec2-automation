...
| **Start EC2** | Start a stopped EC2 instance | EventBridge `cron(30 4 * * ? *)` → 10:00 AM IST | Automatically starts the EC2 instance at the start of the workday. |
| **Stop EC2** | Stop a running EC2 instance | EventBridge `cron(30 12 * * ? *)` → 06:00 PM IST | Stops the EC2 instance to optimize cost. |
